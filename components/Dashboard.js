...
const Page = () => {
  ...
  return (
    ...
    <form className="mx-auto max-w-xl" action={handleSubmit}>
      ...
      <div className="my-2">
        <label className="block mb-2 text-sm font-medium text-white" htmlFor="profilepic">Profile Picture</label>
      ...
      <div className="my-2">
        <label className="block mb-2 text-sm font-medium text-white" htmlFor="coverpic">Cover Picture</label>
      ...
      <div className="my-2">
        <label className="block mb-2 text-sm font-medium text-white" htmlFor="razorpaycredentials">Razorpay ID</label>
      ...
      <div className="my-2">
        <label className="block mb-2 text-sm font-medium text-white" htmlFor="razorpaycredentials">Razorpay Secret</label>
